...
export class HandbookComponent implements OnInit {
  sections = [
    /* section_1 */
    {
      ...
      content: [
        ...
        {
          text: 'Es gibt zwei Arten von Spielen. Du kannst an dem Ort spielen, wo du gerade bist (Realraum) oder in der virutellen Welt. Im Realraum kannst du unten über "Map" nach Spielen in deiner Nähe suchen. Außerdem kannst du nach Einzelspieler-Spielen und Mehrspieler-Spielen filtern.',
          images: ["2", "3"],
        },
        {
  ...
  sections2 = [
    /* section_1 */
    {
      ...
      path: "assets/handbook/vr-spiel-erstellen",
      content: [
        {
    ...
    /* section_2 */
    {
      ...
      path: "assets/handbook/vr-spiel-bearbeiten",
      content: [
        {
