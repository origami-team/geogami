...
export class LandmarkControlComponent implements OnInit, OnChanges {
    @Input() landmark: GeoJSON.FeatureCollection<any>;
    @Input() qtLandmark: GeoJSON.FeatureCollection<any>;
    @Input() searchArea: GeoJSON.FeatureCollection<any>;

    private secondaryColor: string;
    private dangerColor;

    landmarksGeometry: GeoJSON.FeatureCollection<any> = {
        features: [],
    ...
    qtGeometry: GeoJSON.FeatureCollection<any> = {
        features: [],
        type: 'FeatureCollection'
    };
    ...
    searchAreaGeometry: GeoJSON.FeatureCollection<any> = {
        features: [],
        type: 'FeatureCollection'
    };
